...
*/
	    ...
	    float guiRatioX = sWidth/240.0f * sizegui;
	    float guiRatioY = sHeight/210.0f * sizegui;

	    float scale = Mathf.Min(6.0f, Mathf.Min(guiRatioX, guiRatioY));
		...
		scrollArea = new Rect(-10, BANNER_HEIGHT, ELEMENT_WIDTH, REQUIRED_HEIGHT);
